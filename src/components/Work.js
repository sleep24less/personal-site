    ...
    return (
        ...
        >
            <h1 className='text_section'>
                <i className='fa-solid fa-laptop-code'></i> My work
            </h1>
            <h1 className='text_intro'>
                All of these projects were done while learning front-end
                development.
            </h1>
            <p className='text'>
                Creating these projects helped me learn and solidify my
                new-found knowledge on HTML, CSS, JavaScript and React. This
                personal/portfolio website is my latest finished project created
                using React.
            </p>
            <div className='grid'>
                <Project
