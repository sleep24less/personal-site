    ...
    return (
        ...
        >
            ...
            <h1 className='text_title'>
                <b className='text_gradient'>Front-End Developer</b>
                <b>, specializing in </b>
                <b className='text_gradient'>React.</b>
            </h1>
            <p className='text'>
                Former architect turned Front-End Developer with a passion for
                programming. My background in design and composition, along with
                a disciplined work ethic, has shaped me into{' '}
            ...
            <div className='section_info'>
                <div className='info' data-aos='fade-up'>
                    ...
                    <p className='text'>
                        Most of my projects were completed during my time
                        learning on{' '}
                        <a
                        ...
                        , a free programming course. I learned something new
                        every day and gained valuable knowledge with each
                        project I tackled.
                    </p>
                    <p className='text'>
                        What I enjoyed most about these projects was the lack of
                        hand-holding. Each project came with a description of
                        its desired functionality, a few hints, and the
                        suggestion to "use Google" to figure out the rest. This
                        approach allowed me to truly test and expand my
                ...
                <div className='section_container about_work'>
                    <div data-aos='fade-right' className='left_section'>
                        ...
                        <p className='text'>
                            <i className='fab fa-github'></i>{' '}
                            sleep24less/tenzies-game
                        </p>
                        <p className='text'>
                            <i className='fab fa-github'></i>{' '}
                            sleep24less/calculator
                        </p>
                        <p className='text'>
                            <i className='fab fa-github'></i>{' '}
                            sleep24less/rock-paper-scissors
                        </p>
                        <p className='text'>
                            <i className='fab fa-github'></i>{' '}
                            sleep24less/etch-a-sketch
                        </p>
