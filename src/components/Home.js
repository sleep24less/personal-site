    ...
    return (
        ...
        >
            ...
            <div className='section_info'>
                <h1 data-aos='fade-left' className='text_section'><i class="fa-solid fa-laptop-code"></i> My work</h1>
                <p data-aos='fade-right' className='text'>All of my projects are were made while learning on a free programming course called <a href='https://www.theodinproject.com/' target='_blank'>The Odin Project</a>. I learned new things everyday and progressed my knowledge with each project I did.</p>
